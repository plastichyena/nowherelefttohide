...
describe('Agent Metrics', { timeout: 120000 }, () => {
  ...
  it('collects required game-level values and deterministic action counts', () => {
    ...
    expect(run.metrics.bridgeApiVersion).toBe('18.0.0');
  ...
  it('classifies every Military Goods and Emergency Movement metric from public facts', () => {
    ...
    expect(metrics.fixedMilitaryGoodsConsumedByType).toEqual({ police: 0, nationalGuard: 1, riotPolice: 0, reconTeam: 0, specialForces: 0 });
    expect(metrics.attackMilitaryGoodsConsumedByType).toEqual({ police: 0, nationalGuard: 2, riotPolice: 0, reconTeam: 0, specialForces: 0 });
    expect(metrics.counterattackMilitaryGoodsConsumedByType).toEqual({ police: 0, nationalGuard: 1, riotPolice: 0, reconTeam: 0, specialForces: 0 });
    expect(metrics.interceptionMilitaryGoodsConsumedByType).toEqual({ police: 0, nationalGuard: 2, riotPolice: 0, reconTeam: 0, specialForces: 0 });
    expect(metrics.suppressionMilitaryGoodsConsumedByType).toEqual({ police: 1, nationalGuard: 0, riotPolice: 0, reconTeam: 0, specialForces: 0 });
    expect(metrics.militaryGoodsRefilledByType).toEqual({ police: 4, nationalGuard: 0, riotPolice: 0, reconTeam: 0, specialForces: 0 });
    expect(metrics.unfilledMilitaryGoodsRefillByType).toEqual({ police: 3, nationalGuard: 0, riotPolice: 0, reconTeam: 0, specialForces: 0 });
    expect(metrics.militaryGoodsLostOnDestructionByType).toEqual({ police: 3, nationalGuard: 0, riotPolice: 0, reconTeam: 0, specialForces: 0 });
    expect(metrics.zeroMilitaryGoodsWeakAttacksByType).toEqual({ police: 1, nationalGuard: 0, riotPolice: 0, reconTeam: 0, specialForces: 0 });
    ...
    expect(metrics.emergencyMovesByType).toEqual({ police: 1, nationalGuard: 1, riotPolice: 0, reconTeam: 0, specialForces: 0 });
    expect(metrics.emergencyMovementHexesByType).toEqual({ police: 2, nationalGuard: 1, riotPolice: 0, reconTeam: 0, specialForces: 0 });
    expect(metrics.emergencyMovementPointsByType).toEqual({ police: 3, nationalGuard: 2, riotPolice: 0, reconTeam: 0, specialForces: 0 });
    expect(metrics.emergencyReturnsToSupplyByType).toEqual({ police: 1, nationalGuard: 0, riotPolice: 0, reconTeam: 0, specialForces: 0 });
  });
