...
const CSV_COLUMNS: readonly string[] = [
  ...
  'finalSecuredFacilities', 'policeProduced', 'nationalGuardProduced', 'riotPoliceProduced', 'unitLosses', 'zombiesKilled',
  'policeInitial', 'nationalGuardInitial', 'riotPoliceInitial', 'policeLosses', 'nationalGuardLosses', 'riotPoliceLosses',
  'policeFinal', 'nationalGuardFinal', 'riotPoliceFinal',
  'policeSurvivalRate', 'nationalGuardSurvivalRate', 'riotPoliceSurvivalRate', 'outOfSupplyUnitLosses',
  'recruitsCommissioned.police', 'recruitsCommissioned.nationalGuard', 'recruitsCommissioned.riotPolice',
  ...
  'noisePulsesEmitted', 'policeNoisePulses', 'nationalGuardNoisePulses', 'riotPoliceNoisePulses', 'hordeMovementNoisePulses',
  'noisePulsesBySourceType.police', 'noisePulsesBySourceType.nationalGuard', 'noisePulsesBySourceType.riotPolice', 'noisePulsesBySourceType.hordeZombie',
  ...
  'hordeNoiseRespawned.zombie', 'hordeNoiseRespawned.policeZombie', 'hordeNoiseRespawned.soldierZombie', 'hordeNoiseRespawned.riotZombie',
  ...
  'mapWidth', 'mapHeight',
  'humanHexesMoved.police', 'humanHexesMoved.nationalGuard', 'humanHexesMoved.riotPolice',
  'maxSingleMoveDistance.police', 'maxSingleMoveDistance.nationalGuard', 'maxSingleMoveDistance.riotPolice',
  'longMoves6Plus.police', 'longMoves6Plus.nationalGuard', 'longMoves6Plus.riotPolice', 'policeLongRangeMoves',
  'unitFuelConsumed.police', 'unitFuelConsumed.nationalGuard', 'unitFuelConsumed.riotPolice',
  'unitFuelRefilled.police', 'unitFuelRefilled.nationalGuard', 'unitFuelRefilled.riotPolice',
  'commissioningFuel.police', 'commissioningFuel.nationalGuard', 'commissioningFuel.riotPolice',
  'turnsUnitsEndedOutOfSupply.police', 'turnsUnitsEndedOutOfSupply.nationalGuard', 'turnsUnitsEndedOutOfSupply.riotPolice',
  'unitsUnableToMoveForFuel', 'stateFuelSpentOnPower', 'stateFuelSpentOnUnits', 'fuelShortageTurns',
  'fixedMilitaryGoodsConsumed.police', 'fixedMilitaryGoodsConsumed.nationalGuard', 'fixedMilitaryGoodsConsumed.riotPolice',
  'attackMilitaryGoodsConsumed.police', 'attackMilitaryGoodsConsumed.nationalGuard', 'attackMilitaryGoodsConsumed.riotPolice',
  'counterattackMilitaryGoodsConsumed.police', 'counterattackMilitaryGoodsConsumed.nationalGuard', 'counterattackMilitaryGoodsConsumed.riotPolice',
  'interceptionMilitaryGoodsConsumed.police', 'interceptionMilitaryGoodsConsumed.nationalGuard', 'interceptionMilitaryGoodsConsumed.riotPolice',
  'suppressionMilitaryGoodsConsumed.police', 'suppressionMilitaryGoodsConsumed.nationalGuard', 'suppressionMilitaryGoodsConsumed.riotPolice',
  'militaryGoodsRefilled.police', 'militaryGoodsRefilled.nationalGuard', 'militaryGoodsRefilled.riotPolice',
  'unfilledMilitaryGoodsRefill.police', 'unfilledMilitaryGoodsRefill.nationalGuard', 'unfilledMilitaryGoodsRefill.riotPolice',
  'militaryGoodsLostOnDestruction.police', 'militaryGoodsLostOnDestruction.nationalGuard', 'militaryGoodsLostOnDestruction.riotPolice',
  'zeroMilitaryGoodsWeakAttacks.police', 'zeroMilitaryGoodsWeakAttacks.nationalGuard', 'zeroMilitaryGoodsWeakAttacks.riotPolice',
  ...
  'emergencyMoves.police', 'emergencyMoves.nationalGuard', 'emergencyMoves.riotPolice',
  'emergencyMovementHexes.police', 'emergencyMovementHexes.nationalGuard', 'emergencyMovementHexes.riotPolice',
  'emergencyMovementPoints.police', 'emergencyMovementPoints.nationalGuard', 'emergencyMovementPoints.riotPolice',
  'emergencyReturnsToSupply.police', 'emergencyReturnsToSupply.nationalGuard', 'emergencyReturnsToSupply.riotPolice',
  ...
  'unusedAttackChargesByTurn', 'criticalInfectionAlertUnresolvedTurns',
  ...
  'preventedRefugeeArrivalsAfterFinal', 'policeReanimations', 'nationalGuardReanimations', 'riotPoliceReanimations',
  ...
  ...CSV_WAVE_INDICES.flatMap((index) => [
    ...
    `hordeWave.${index}.variantSlotCountPerDirection`,
...
export function metricsToCsv(games: readonly GameMetrics[]): string {
  ...
  for (const game of games) {
    const values: unknown[] = [
      ...
      game.finalSecuredFacilities, game.policeProduced, game.nationalGuardProduced, game.riotPoliceProduced, game.unitLosses,
      game.zombiesKilled,
      game.policeInitial, game.nationalGuardInitial, game.riotPoliceInitial,
      game.policeLosses, game.nationalGuardLosses, game.riotPoliceLosses,
      game.policeFinal, game.nationalGuardFinal, game.riotPoliceFinal,
      game.policeSurvivalRate, game.nationalGuardSurvivalRate, game.riotPoliceSurvivalRate, game.outOfSupplyUnitLosses,
      game.recruitsCommissionedByType.police, game.recruitsCommissionedByType.nationalGuard, game.recruitsCommissionedByType.riotPolice,
      ...
      game.noisePulsesEmitted, game.policeNoisePulses, game.nationalGuardNoisePulses, game.riotPoliceNoisePulses,
      game.hordeMovementNoisePulses,
      game.noisePulsesBySourceType.police, game.noisePulsesBySourceType.nationalGuard,
      game.noisePulsesBySourceType.riotPolice, game.noisePulsesBySourceType.hordeZombie,
      ...
      game.hordeNoiseRespawnedByType.zombie, game.hordeNoiseRespawnedByType.policeZombie,
      game.hordeNoiseRespawnedByType.soldierZombie, game.hordeNoiseRespawnedByType.riotZombie,
      ...
      game.humanHexesMovedByType.police, game.humanHexesMovedByType.nationalGuard, game.humanHexesMovedByType.riotPolice,
      game.maxSingleMoveDistanceByType.police, game.maxSingleMoveDistanceByType.nationalGuard, game.maxSingleMoveDistanceByType.riotPolice,
        game.longMoves6PlusByType.police, game.longMoves6PlusByType.nationalGuard, game.longMoves6PlusByType.riotPolice, game.policeLongRangeMoves,
      game.unitFuelConsumedByType.police, game.unitFuelConsumedByType.nationalGuard, game.unitFuelConsumedByType.riotPolice,
      game.unitFuelRefilledByType.police, game.unitFuelRefilledByType.nationalGuard, game.unitFuelRefilledByType.riotPolice,
      game.commissioningFuelByType.police, game.commissioningFuelByType.nationalGuard, game.commissioningFuelByType.riotPolice,
      game.turnsUnitsEndedOutOfSupplyByType.police, game.turnsUnitsEndedOutOfSupplyByType.nationalGuard, game.turnsUnitsEndedOutOfSupplyByType.riotPolice,
      game.unitsUnableToMoveForFuel, game.stateFuelSpentOnPower, game.stateFuelSpentOnUnits, game.fuelShortageTurns,
      game.fixedMilitaryGoodsConsumedByType.police, game.fixedMilitaryGoodsConsumedByType.nationalGuard, game.fixedMilitaryGoodsConsumedByType.riotPolice,
      game.attackMilitaryGoodsConsumedByType.police, game.attackMilitaryGoodsConsumedByType.nationalGuard, game.attackMilitaryGoodsConsumedByType.riotPolice,
      game.counterattackMilitaryGoodsConsumedByType.police, game.counterattackMilitaryGoodsConsumedByType.nationalGuard, game.counterattackMilitaryGoodsConsumedByType.riotPolice,
      game.interceptionMilitaryGoodsConsumedByType.police, game.interceptionMilitaryGoodsConsumedByType.nationalGuard, game.interceptionMilitaryGoodsConsumedByType.riotPolice,
      game.suppressionMilitaryGoodsConsumedByType.police, game.suppressionMilitaryGoodsConsumedByType.nationalGuard, game.suppressionMilitaryGoodsConsumedByType.riotPolice,
      game.militaryGoodsRefilledByType.police, game.militaryGoodsRefilledByType.nationalGuard, game.militaryGoodsRefilledByType.riotPolice,
      game.unfilledMilitaryGoodsRefillByType.police, game.unfilledMilitaryGoodsRefillByType.nationalGuard, game.unfilledMilitaryGoodsRefillByType.riotPolice,
      game.militaryGoodsLostOnDestructionByType.police, game.militaryGoodsLostOnDestructionByType.nationalGuard, game.militaryGoodsLostOnDestructionByType.riotPolice,
      game.zeroMilitaryGoodsWeakAttacksByType.police, game.zeroMilitaryGoodsWeakAttacksByType.nationalGuard, game.zeroMilitaryGoodsWeakAttacksByType.riotPolice,
      ...
      game.emergencyMovesByType.police, game.emergencyMovesByType.nationalGuard, game.emergencyMovesByType.riotPolice,
      game.emergencyMovementHexesByType.police, game.emergencyMovementHexesByType.nationalGuard, game.emergencyMovementHexesByType.riotPolice,
      game.emergencyMovementPointsByType.police, game.emergencyMovementPointsByType.nationalGuard, game.emergencyMovementPointsByType.riotPolice,
      game.emergencyReturnsToSupplyByType.police, game.emergencyReturnsToSupplyByType.nationalGuard, game.emergencyReturnsToSupplyByType.riotPolice,
      ...
      game.unusedAttackChargesByTurn, game.criticalInfectionAlertUnresolvedTurns,
      ...
      game.resourceSinglePointFailureTurnsByResource.electricity ?? 0,
        ...
        game.preventedRefugeeArrivalsAfterFinal, game.policeReanimations, game.nationalGuardReanimations, game.riotPoliceReanimations,
       ...
       ...CSV_WAVE_INDICES.flatMap((index) => {
         ...
         return [
           ...
           wave?.normalZombieSpawned ?? 0,
            ...
            wave?.variantSlotCountPerDirection ?? '',
