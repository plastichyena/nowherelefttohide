...
export const RULES_V163 = {
  ja: {
    ...
    nuclear: '原子力発電所は州の電力供給を支える重要施設だ。最後の通信では精鋭部隊が守備に就いていたが、生死は不明。Turn10までの初回確保で特殊部隊1隊が満載・即行動可能で合流します。未確保ならTurn11にPack Zombieが出現します。原発はSupply内・感染なし・稼働中に1人500、5人で2500電力をFuelなしで供給します。',
  ...
  en: {
    ...
    nuclear: 'The nuclear plant once sustained the state. Its last transmission reported an elite guard; their fate is unknown. First capture by Turn 10 awards one fully supplied Special Forces unit ready to act. Never captured by Turn 11: one Pack Zombie appears. An owned, uninfected, operating plant needs Supply and generates 500 electricity per worker, up to 2500 with five workers, without Fuel.',
