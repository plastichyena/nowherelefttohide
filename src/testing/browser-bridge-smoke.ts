...
function run(): void {
  ...
  for (const marker of [
    '1.6.2', '12.0.0', '13.0.0', '16.0.0', '17.0.0', 'fixed-51x51-v7', 'gasZombie', 'screamerZombie', 'reconTeam', 'armyBase', 'oilField', 'SetPowerSupply',
    ...
    if (!bundle.includes(marker)) fail(`production bundle does not contain v1.6.2 schema marker: ${marker}`);
  }
