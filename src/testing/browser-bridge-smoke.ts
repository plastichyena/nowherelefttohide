...
function run(): void {
  ...
  for (const marker of [
    '1.5.4', '6.0.0', '10.0.0', '11.0.0', 'fixed-51x51-v3', 'gasZombie', 'armyBase', 'SetPowerSupply',
    ...
    if (!bundle.includes(marker)) fail(`production bundle does not contain v1.5.4 schema marker: ${marker}`);
  }
