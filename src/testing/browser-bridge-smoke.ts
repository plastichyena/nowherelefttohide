...
function run(): void {
  ...
  for (const marker of [
    ...
    if (!bundle.includes(marker)) fail(`production bundle does not contain v1.6.5 schema marker: ${marker}`);
  }
